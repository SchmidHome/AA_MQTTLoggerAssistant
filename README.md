...
# USAGE
```c++
MQTTassistant mqtt(MQTT_SERVER, MQTT_PORT, MQTT_USER, MQTT_PASSWORD);
MQTTLoggerAssistant logger(mqtt, "log"); // sets logger as default as third argument is true per default
